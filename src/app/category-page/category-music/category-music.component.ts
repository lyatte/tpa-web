...
export class CategoryMusicComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(localStorage.getItem('user') == null){
      this.vids.getAllTimePopular(rest, "3", "Music").subscribe( r => {
        console.log(r)
        this.videos1 = r;
      } )
  
      this.vids.getVideoWeek(rest, "3", "Music").subscribe( r => {
        console.log(r)
        this.videos2 = r;
      } )
  
      this.vids.getVideoMonth(rest, "3", "Music").subscribe( r => {
        console.log(r)
        this.videos3 = r;
      } )

      this.vids.getVideoRecent(rest, "3", "Music").subscribe( r => {
        console.log(r)
        this.videos4 = r;
      } )
    }else{
      ...
      this.user.getUser().subscribe( us => {
        ...
        this.apollo.watchQuery( {
          ...
          this.vids.getAllTimePopular(rest, user.data.getChannelById.channel_premium, "Music").subscribe( r => {
            console.log(r)
            this.videos1 = r;
          ...
          this.vids.getVideoWeek(rest, user.data.getChannelById.channel_premium, "Music").subscribe( r => {
            console.log(r)
            this.videos2 = r;
          ...
          this.vids.getVideoMonth(rest, user.data.getChannelById.channel_premium, "Music").subscribe( r => {
            console.log(r)
            this.videos3 = r;
          ...
          this.vids.getVideoRecent(rest, user.data.getChannelById.channel_premium, "Music").subscribe( r => {
            console.log(r)
            this.videos4 = r;
