...
@Component({
  selector: 'app-category-travel',
  templateUrl: './category-travel.component.html',
  styleUrls: ['./category-travel.component.scss']
})
export class CategoryTravelComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(localStorage.getItem('user') == null){
      this.vids.getAllTimePopular(rest, "3", "Travel").subscribe( r => {
        console.log(r)
        this.videos1 = r;
      } )
  
      this.vids.getVideoWeek(rest, "3", "Travel").subscribe( r => {
        console.log(r)
        this.videos2 = r;
      } )
  
      this.vids.getVideoMonth(rest, "3", "Travel").subscribe( r => {
        console.log(r)
        this.videos3 = r;
      } )

      this.vids.getVideoRecent(rest, "3", "Travel").subscribe( r => {
        console.log(r)
        this.videos4 = r;
      } )
    }else{
      this.user.getUser().subscribe( us => {
        ...
        this.apollo.watchQuery( {
          ...
          this.vids.getAllTimePopular(rest, user.data.getChannelById.channel_premium, "Travel").subscribe( r => {
            console.log(r)
            this.videos1 = r;
          ...
          this.vids.getVideoWeek(rest, user.data.getChannelById.channel_premium, "Travel").subscribe( r => {
            console.log(r)
            this.videos2 = r;
          ...
          this.vids.getVideoMonth(rest, user.data.getChannelById.channel_premium, "Travel").subscribe( r => {
            console.log(r)
            this.videos3 = r;
          ...
          this.vids.getVideoRecent(rest, user.data.getChannelById.channel_premium, "Travel").subscribe( r => {
            console.log(r)
            this.videos4 = r;
